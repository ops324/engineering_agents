...
| [EXP-042](EXP-042-plan-3-shrinks-to-one-bit.md) | 案3 の S1。**過去3回は崖の下側で測っていた**（窓200 で生き残る点は 12/16 実在）。定数は全セルを取れないが、**余地の 57.7% が1ビットで取れ交差検証で1点も落ちない** | **confirmed**（未監査。S1 は落ちた＝4回目。ただし落ち方が違う） |
